...
pay.addEventListener("click", () => {
  ...
  r7td2.textContent = `Euro ${money * Number(billingInfo.Days)} /-`;
  ...
  r9td2.textContent = ` Euro ${
    Number(gstAmt) + money * Number(billingInfo.Days)
  } /-`;
